...
export type SubscriptionWhereInput = {
  ...
  id_subscription?: Prisma.StringFilter<"Subscription"> | string
  id_user?: Prisma.StringFilter<"Subscription"> | string
...
export type SubscriptionScalarWhereWithAggregatesInput = {
  ...
  id_subscription?: Prisma.StringWithAggregatesFilter<"Subscription"> | string
  id_user?: Prisma.StringWithAggregatesFilter<"Subscription"> | string
...
export type SubscriptionUpdateInput = {
  id_subscription?: Prisma.StringFieldUpdateOperationsInput | string
...
export interface SubscriptionDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `id_subscription`
   * const subscriptionWithId_subscriptionOnly = await prisma.subscription.findMany({ select: { id_subscription: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Subscriptions and only return the `id_subscription`
   * const subscriptionWithId_subscriptionOnly = await prisma.subscription.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Subscriptions and only return the `id_subscription`
   * const subscriptionWithId_subscriptionOnly = await prisma.subscription.updateManyAndReturn({
   *   select: { id_subscription: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface SubscriptionFieldRefs {
  readonly id_subscription: Prisma.FieldRef<"Subscription", 'String'>
  readonly id_user: Prisma.FieldRef<"Subscription", 'String'>
